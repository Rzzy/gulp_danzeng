...
(function e(t, n, r) {
  ...
  5: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      var cleateSwiper = require('./modules/walking_lantern.js');
      ...
      function setRem() {
        // 默认使用100px作为基准大小
        var baseSize = 100;
        var baseVal = baseSize / 1920;
        var vW = window.innerWidth; // 当前窗口的宽度

        var rem = vW * baseVal; // 以默认比例值乘以当前窗口宽度,得到该宽度下的相应font-size值
    ...
    }).call(this, require("Xy56Sy"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/fake_7bed003b.js", "/");
  }, {
    "./modules/navigator.js": 6,
    "./modules/walking_lantern.js": 7,
    "Xy56Sy": 4,
    "buffer": 1
  }],
  6: [function (require, module, exports) {
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      function navigator() {
        var navigators_wrap = document.querySelector('#navigator_slide_wrap');
        var navigators = document.querySelectorAll('.navigator-list li a');
        var timer = null;

        var _loop = function _loop(_i) {
          var el = navigators[_i];
          el.addEventListener('mouseenter', function () {
            ...
            clearOtherNavActive(_i, navigators);
            showCurentSlide(_i);
          }, false);
        ...
        for (var _i = 0; _i < navigators.length; _i++) {
          _loop(_i);
        }
      ...
      function showCurentSlide(index) {
        index = index - 1;
        var navigators_wrap = document.querySelector('#navigator_slide_wrap');
        var navigators_slides = navigators_wrap.querySelectorAll('.navigator_slide');

        for (var _i3 = 0; _i3 < navigators_slides.length; _i3++) {
          if (_i3 === index) {
            navigators_slides[_i3].style.display = 'block';
          } else {
            navigators_slides[_i3].style.display = 'none';
          }
    ...
    }).call(this, require("Xy56Sy"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/modules\\navigator.js", "/modules");
  }, {
    "Xy56Sy": 4,
    "buffer": 1
  }],
  7: [function (require, module, exports) {
    ...
    }).call(this, require("Xy56Sy"), typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {}, require("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/modules\\walking_lantern.js", "/modules");
  }, {
    "Xy56Sy": 4,
    "buffer": 1
  }]
